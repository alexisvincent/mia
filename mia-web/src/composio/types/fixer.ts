...
/**
 * Type of FIXER's FIXER_GET_HISTORICAL_RATES tool input.
 */
type FIXER_GET_HISTORICAL_RATES_INPUT = {
  /**
   * Base
   * @description Three-letter base currency code (defaults to EUR if omitted)
   * @default null
   */
  base: string | null;
  /**
  ...
  /**
   * Symbols
   * @description List of target currency codes to limit output. If omitted, all available currencies are returned
   * @default null
   */
  symbols: string[] | null;
};
...
/**
 * Type of FIXER's FIXER_GET_HISTORICAL_RATES tool output.
 */
type FIXER_GET_HISTORICAL_RATES_OUTPUT = {
  /**
   * Data
  ...
  data?: {
      ...
      /**
       * Date
       * @description The date of the returned rates.
       */
      date: string;
      /**
       * Historical
       * @description True if this is historical data.
       */
      historical: boolean;
      /**
       * Rates
      ...
      /**
       * Timestamp
       * @description UNIX timestamp of the rates data.
       */
      timestamp: number;
  };
  /**
...
/**
 * Type of FIXER's FIXER_GET_LATEST_RATES tool input.
 */
type FIXER_GET_LATEST_RATES_INPUT = {
  /**
   * Base
   * @description The base currency to which exchange rates are relative. Defaults to 'EUR'. Changing the base currency is only available on paid plans.
   * @default null
   */
  base: string | null;
  /**
   * Symbols
   * @description List of currency codes to limit the response. Provide as a list, e.g., ['USD', 'GBP']. If omitted, all available currencies are returned.
   * @default null
   */
  symbols: string[] | null;
};
...
/**
 * Type of FIXER's FIXER_GET_LATEST_RATES tool output.
 */
type FIXER_GET_LATEST_RATES_OUTPUT = {
  /**
   * Data
   * @description Data from the action execution
   */
  data?: {
      /**
       * Base
       * @description The base currency used for the exchange rates.
       */
      base: string;
      /**
       * Date
       * @description Date of the exchange rates in YYYY-MM-DD format.
       */
      date: string;
      /**
       * Rates
       * @description Key-value pairs of currency codes and their corresponding exchange rates relative to the base currency.
       */
      rates: {
          [key: string]: number;
      };
      ...
      /**
       * Timestamp
       * @description UNIX timestamp of when the data was collected.
       */
      timestamp: number;
  };
  /**
...
/**
 * Type of FIXER's FIXER_GET_SUPPORTED_SYMBOLS tool input.
 */
type FIXER_GET_SUPPORTED_SYMBOLS_INPUT = object;

/**
 * Type of FIXER's FIXER_GET_SUPPORTED_SYMBOLS tool output.
 */
type FIXER_GET_SUPPORTED_SYMBOLS_OUTPUT = {
  /**
   * Data
   * @description Data from the action execution
   */
  data?: {
      ...
      /**
       * Symbols
       * @description Mapping of currency symbols to their full currency names.
       */
      symbols: {
          [key: string]: string;
      };
...
/**
 * Type of FIXER's FIXER_IO_CONVERT_CURRENCY tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_CONVERT_CURRENCY tool output.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_FLUCTUATION tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_FLUCTUATION tool output.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_HISTORICAL_RATES tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_HISTORICAL_RATES tool output.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_LATEST_RATES tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_LATEST_RATES tool output.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_SUPPORTED_SYMBOLS tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_SUPPORTED_SYMBOLS tool output.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_TIME_SERIES tool input.
 */
...
/**
 * Type of FIXER's FIXER_IO_GET_TIME_SERIES tool output.
 */
...
/**
 * Type map of all available tool input types for toolkit "FIXER".
 */
export type FIXER_TOOL_INPUTS = {
  GET_HISTORICAL_RATES: FIXER_GET_HISTORICAL_RATES_INPUT
  GET_LATEST_RATES: FIXER_GET_LATEST_RATES_INPUT
  GET_SUPPORTED_SYMBOLS: FIXER_GET_SUPPORTED_SYMBOLS_INPUT
  IO_CONVERT_CURRENCY: FIXER_IO_CONVERT_CURRENCY_INPUT
  IO_GET_FLUCTUATION: FIXER_IO_GET_FLUCTUATION_INPUT
  IO_GET_HISTORICAL_RATES: FIXER_IO_GET_HISTORICAL_RATES_INPUT
  IO_GET_LATEST_RATES: FIXER_IO_GET_LATEST_RATES_INPUT
  IO_GET_SUPPORTED_SYMBOLS: FIXER_IO_GET_SUPPORTED_SYMBOLS_INPUT
  IO_GET_TIME_SERIES: FIXER_IO_GET_TIME_SERIES_INPUT
}

/**
 * Type map of all available tool input types for toolkit "FIXER".
 */
export type FIXER_TOOL_OUTPUTS = {
  GET_HISTORICAL_RATES: FIXER_GET_HISTORICAL_RATES_OUTPUT
  GET_LATEST_RATES: FIXER_GET_LATEST_RATES_OUTPUT
  GET_SUPPORTED_SYMBOLS: FIXER_GET_SUPPORTED_SYMBOLS_OUTPUT
  IO_CONVERT_CURRENCY: FIXER_IO_CONVERT_CURRENCY_OUTPUT
  IO_GET_FLUCTUATION: FIXER_IO_GET_FLUCTUATION_OUTPUT
  IO_GET_HISTORICAL_RATES: FIXER_IO_GET_HISTORICAL_RATES_OUTPUT
  IO_GET_LATEST_RATES: FIXER_IO_GET_LATEST_RATES_OUTPUT
  IO_GET_SUPPORTED_SYMBOLS: FIXER_IO_GET_SUPPORTED_SYMBOLS_OUTPUT
  IO_GET_TIME_SERIES: FIXER_IO_GET_TIME_SERIES_OUTPUT
}
...
/**
 * Type map of all available trigger payloads for toolkit "FIXER".
 */
export type FIXER_TRIGGER_PAYLOADS = {}

/**
 * Type map of all available trigger events for toolkit "FIXER".
 */
export type FIXER_TRIGGER_EVENTS = {}
