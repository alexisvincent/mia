...
- [The "in" list](#the-in-list)
- [Processing the "in" list](#processing-the-in-list)
- [The "next actions" list](#the-next-actions-list)
- [The "waiting for" list](#the-waiting-for-list)
- [Projects](#projects)
- [Contexts](#contexts)
  - [Examples of actions and their contexts](#examples-of-actions-and-their-contexts)
  - [Agenda contexts](#agenda-contexts)
- [The "some day/maybe" list](#the-some-daymaybe-list)
- [Calendar](#calendar)
- [Weekly review](#weekly-review)
  - [Trigger lists](#trigger-lists)
- [Getting it to work](#getting-it-to-work)
- [Tools](#tools)
  - [Read/review folder](#readreview-folder)
...
> **Note:** If you have just started to use GTD and collected tonnes of items in your **in** list during the initial "brain-emptying", processing can take a while. From now on the **in** list will be processed continuously.
